...
typedef void (*func)(int i); // 真的感觉没有 c++ 的 using 好用
...
typedef int (*compare)(const void *num1, const void *num2);
...
int main() {
    ...
    printf("max = %d\n", *(int *)getMaxArrValue(num, sizeof(int), sizeof(num) / sizeof(int), compareInt));
    return 0;
}
